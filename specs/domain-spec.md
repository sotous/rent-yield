...
- [frontend-spec.md](frontend-spec.md) defines the user-facing explorer behavior
- [frontend-interaction-spec.md](frontend-interaction-spec.md) defines map state, chart state, area selection, responsive behavior, and fake-data interaction requirements
